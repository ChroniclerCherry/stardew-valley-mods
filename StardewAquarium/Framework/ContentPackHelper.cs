...
namespace StardewAquarium.Framework
{
    ...
    internal static class ContentPackHelper
    {
        ...
        *********/
        ...
        internal const string LegendaryBaitQualifiedId = $"{ItemRegistry.type_object}{ContentPackId}_LegendaryBait";

        /// <summary>The qualified item ID for the Pufferchick item.</summary>
        internal const string PufferchickQualifiedId = $"{ItemRegistry.type_object}{ContentPackId}_Pufferchick";

        /// <summary>The internal name of the location outside the Stardew Aquarium.</summary>
        internal const string ExteriorLocationName = $"{ContentPackId}_ExteriorMuseum";

        /// <summary>The internal name of the main location inside the Stardew Aquarium.</summary>
        internal const string InteriorLocationName = $"{ContentPackId}_FishMuseum";
