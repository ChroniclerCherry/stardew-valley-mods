...
/// <summary>The Expanded Preconditions Utility API.</summary>
public interface IConditionsChecker
{
    /// <summary>Must be called before any condition checking is done. Verbose mode will turn on logging for every step of the condition checking process.</summary>
    ...
    /// <summary>Checks an array of condition strings. Each string will be evaluated as true if every single condition provided is true. All the strings together will evaluate as true if any string is true.</summary>
